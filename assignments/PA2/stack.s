...
class_objTab:
	...
	.word	Stack_protObj
	.word	Stack_init
	.word	StackManager_protObj
	.word	StackManager_init
	.word	Main_protObj
	.word	Main_init
	.word	Int_protObj
	.word	Int_init
...
StackManager_dispTab:
	...
	.word	Stack.getStack
	.word	Stack.setStack
	.word	StackManager.print
	.word	StackManager.execute
	.word	-1
Object_protObj:
	.word	0
	.word	3
...
Stack_protObj:
	...
	.word	0
	.word	-1
StackManager_protObj:
	.word	4
	.word	10
	.word	StackManager_dispTab
	.word	str_const1
	.word	0
	.word	str_const1
	.word	str_const1
...
label133:
	...
	lw	$t1 12($t1)
	jalr		$t1
	la	$a0 StackManager_protObj
	jal	Object.copy
	jal	StackManager_init
	sw	$a0 12($s0)
	move	$a0 $s0
